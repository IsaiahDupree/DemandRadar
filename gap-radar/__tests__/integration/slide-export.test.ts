/**
 * Integration Test for Slide Deck Export
 *
 * This test actually generates a PPTX file to verify the full flow
 * Run with: node --loader ts-node/esm __tests__/integration/slide-export.test.ts
 */

import { generateSlides } from '../../src/lib/reports/slide-generator';
import type { ReportData } from '../../src/lib/reports/generator';
