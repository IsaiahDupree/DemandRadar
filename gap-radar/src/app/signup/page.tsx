...
import { trackSignup } from "@/lib/analytics/landing";
import { trackSignupStarted, trackSignupCompleted, markStageCompleted } from "@/lib/analytics/funnel";
...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    // Note: OAuth success tracking happens in the callback page
  };

  const handleGithubSignup = async () => {
    // Track OAuth signup attempt
    trackSignup('started', 'other');
    trackSignupStarted('other');
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Start finding market gaps in minutes
          </CardDescription>
        </CardHeader>
        <CardContent>
